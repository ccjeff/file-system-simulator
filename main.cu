...
#define SUPERBLOCK_SIZE 4096 ///8 bits = 4 K
// Total # of blocks, # of free blocks, block size, free block pointers or array

#define FCB_SIZE 32 //32 bytes per FCB
//FCB storing information like: Inode number, permissions, size, dates
...
#define FILE_BASE_ADDRESS 36864 //4096+32768 SUPERBLOCK + FCB*FCB_ENTRIES-1024
